...
/// @param success When success return TYSuccessBOOL.
/// @param failure When failure return TYFailureError.
...
- (void)deleteSceneWithSuccess:(TYSuccessHandler)success
                       failure:(TYFailureError)failure __deprecated_msg("This method is deprecated, Use -[TuyaSmartScene deleteSceneWithHomeId:success:failure:] instead");
