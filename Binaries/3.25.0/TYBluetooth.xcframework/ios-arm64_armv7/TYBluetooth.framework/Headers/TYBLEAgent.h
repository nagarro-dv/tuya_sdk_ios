...
- (void)onModifyPeripheral:(TYBLEPeripheral *)peripheral didModifyServices:(NSArray *)invalidatedServices;
 ...
 *
 *  @return The TYBLEPeripheral array.
 */
- (NSArray<TYBLEPeripheral *> *)retrieveConnectedPeripheralsWithServices:(NSArray<CBUUID *> *)serviceUUIDs;
