...
/// Sends DPs.
/// @param dps The dp dictionary.
/// @param communicationTypes Use communication order to publish dps. (Array element's value  reference enum TYCommunicationType)
...
/// @param success Called when the task is finished.
/// @param failure Called when the task is interrupted by an error.
/// @deprecated This method is deprecated. Use TuyaSmartDevice::updateIconWithURL:success:failure instead.
- (void)updateIconWithCloudKey:(NSString *)cloudKey
                       success:(nullable TYSuccessHandler)success
                       failure:(nullable TYFailureError)failure __deprecated_msg("This method is deprecated, Use -[TuyaSmartDevice -  updateIconWithURL:success:failure] instead");
...
/// @param success Called when the task is finished.
/// @param failure Called when the task is interrupted by an error.
+ (void)syncSubDeviceLocalKeyWithGatewayId:(NSString *)gatewayId nodeIds:(NSArray<NSString *> *)nodeId success:(nullable TYSuccessList)success failure:(nullable TYFailureError)failure;
...
/// @param success Called when the task is finished.
/// @param failure Called when the task is interrupted by an error.
- (void)subscribeToTopic:(NSString *)topic success:(TYSuccessHandler)success failure:(TYFailureError)failure;

/// unSubscribes to the topic.
/// @param topic the topic
/// @param success Called when the task is finished.
/// @param failure Called when the task is interrupted by an error.
- (void)unsubscribeToTopic:(NSString *)topic success:(TYSuccessHandler)success failure:(TYFailureError)failure;
