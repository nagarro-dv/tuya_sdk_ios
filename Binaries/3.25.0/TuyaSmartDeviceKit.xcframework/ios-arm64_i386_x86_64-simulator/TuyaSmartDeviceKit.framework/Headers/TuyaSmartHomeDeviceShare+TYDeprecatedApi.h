...
#import <TuyaSmartDeviceCoreKit/TuyaSmartReceivedShareUserModel.h>
...
- (void)getShareMemberListWithHomeId:(long long)homeId
                             ...
                             failure:(TYFailureError)failure __deprecated_msg("This method is deprecated, Use [TuyaSmartHomeDeviceShare getShareMemberListWithSpaceId:success:failure:]");
...
- (void)addGroupShareToMemberWithHomeId:(long long)homeId
                            ...
                            userAccount:(NSString *)userAccount
                                ...
                                success:(TYSuccessID)success
                                failure:(TYFailureError)failure __deprecated_msg("This method is deprecated, Use [TuyaSmartHomeDeviceShare addGroupShareToMemberWithSpaceId:countyCode:userAccount:groupId:success:failure:]");
