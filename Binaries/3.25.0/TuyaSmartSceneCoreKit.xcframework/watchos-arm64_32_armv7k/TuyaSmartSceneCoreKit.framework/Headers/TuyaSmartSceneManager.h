...
- (void)removeTopRecommendSceneWithHomeId:(long long)homeId recommendId:(NSString *)recommendId success:(TYSuccessID)success failure:(TYFailureError)failure;
...
/// @param success Success callback.
/// @param failure Failure callback.
- (void)getRecommendDeviceListWithDevIds:(NSArray <NSString *>*)devIds homeId:(long long)homeId success:(void (^)(NSDictionary <NSString *,TuyaSmartSceneModel *>*dict))success failure:(TYFailureError)failure;
...
/// @param success Success callback.
/// @param failure Failure callback.
- (void)getRecommendSceneDetailWithSceneId:(NSString *)sceneId homeId:(long long)homeId success:(void (^)(TuyaSmartSceneModel *sceneModel))success failure:(TYFailureError)failure;
